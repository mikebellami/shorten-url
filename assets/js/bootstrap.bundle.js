   ...
   */
	...
	function arrow(_ref) {
		...
		var clientSize = arrowOffsetParent
			? axis === 'y' ? arrowOffsetParent.clientHeight || 0 : arrowOffsetParent.clientWidth || 0
			: 0;
	...
	function mapToStyles(_ref2) {
		...
		var _ref3 =
				roundOffsets === true
					...
					: typeof roundOffsets === 'function' ? roundOffsets(offsets) : offsets,
			_ref3$x = _ref3.x,
	...
	function preventOverflow(_ref) {
		...
		if (checkMainAxis || checkAltAxis) {
			...
			var clientOffset = arrowOffsetParent
				? mainAxis === 'y' ? arrowOffsetParent.clientTop || 0 : arrowOffsetParent.clientLeft || 0
				: 0;
